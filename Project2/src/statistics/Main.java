...
public class Main {
	...
	public static void main(String[] args) {
		...
		Doctor d3 = new Doctor("Emilia", "Nylén", "e.nylen@gmail.com", "Vasagatan 1", "0762458973", "SHB", "DOCTOR",
		...
		Nurse n1 = new Nurse("Per", "Green", "per.g@gmail.com", "Strandvägen 2", "0762583146", "Swedbank", "NURSE",
				GenderType.MALE, 1958, 06, 27, 6, "12496 32 4", 29500, Qualification.NURSE);
		Nurse n2 = new Nurse("Lisa", "Svensson", "lisa.s@gmail.com", "Tyresögränd 5", "0732651856", "Nordea", "NURSE",
		...
		Nurse n5 = new Nurse("Anders", "Claus", "a.claus@gmail.com", "Landsvägen 78", "0712563202", "SHB", "NURSE",
		...
		Receptionist Rec1 = new Receptionist("Sara", "Svensson", "s.s@gmail.com", "Stockholm", "0700546982", "Nordea",
				"Receptionist", GenderType.FEMALE, 1958, 01, 27, 11, "548451325712", 25000, 0);
		Receptionist Rec2 = new Receptionist("Per", "Ericsson", "p.e@gmail.com", "Stockholm", "0751236985", "Nordea",
				"Receptionist", GenderType.MALE, 1962, 03, 02, 12, "784569875132", 25000, 0);
		Receptionist Rec3 = new Receptionist("Jessica", "Johnson", "j.j@gmail.com", "Stockholm", "0789654125", "Nordea",
				"Receptionist", GenderType.FEMALE, 1963, 12, 05, 13, "412845692137", 25000, 0);
		Receptionist Rec4 = new Receptionist("Maria", "Anders", "m.a@gmail.com", "Stockholm", "0784538795", "Nordea",
				"Receptionist", GenderType.FEMALE, 1979, 10, 12, 14, "875487895462", 25000, 0);
		Receptionist Rec5 = new Receptionist("Julia", "Smith", "j.s@gmail.com", "Stockholm", "0754898787", "Nordea",
				"Receptionist", GenderType.FEMALE, 1980, 12, 20, 15, "316547842531", 25000, 0);
		Researcher Res1 = new Researcher("Linnea", "Parker", "l.p@gmail.com", "Stockholm", "0712312345", "Nordea",
				"Researcher", GenderType.FEMALE, 1956, 06, 25, 16, "879542658715", 50000, 0);
		Researcher Res2 = new Researcher("Erik", "Strand", "e.s@gmail.com", "Stockholm", "0714623587", "Nordea",
				"Researcher", GenderType.MALE, 1978, 11, 28, 17, "635849521236", 50000, 0);
		Researcher Res3 = new Researcher("Elsa", "Andersson", "e.a@gmail.com", "Stockholm", "702158954", "Nordea",
				"Researcher", GenderType.FEMALE, 1989, 10, 07, 18, "963852741123", 50000, 0);
		Researcher Res4 = new Researcher("Marie", "Karlsson", "m.k@gmail.com", "Stockholm", "0713846521", "Nordea",
				"Researcher", GenderType.FEMALE, 1985, 01, 14, 19, "123456987741", 50000, 0);
		Researcher Res5 = new Researcher("Olivia", "Nilsson", "o.n@gmail.com", "Stockholm", "0745457545", "Nordea",
				"Researcher", GenderType.FEMALE, 1983, 02, 17, 20, "741852963123", 50000, 0);

		AmbulanceDriver ad1 = new AmbulanceDriver("Johanna", "Nilsson", "jn@mail.com", "Sollentuna", "0708549785",
				"Nordea", "Ambulance Driver", GenderType.FEMALE, 1988, 10, 27, 21, "352 687 467", 25000, 5);
		AmbulanceDriver ad2 = new AmbulanceDriver("Eric", "Cuszac", "ec@mail.com", "Hägersten", "0707978563", "Nordea",
				"Ambulance Driver", GenderType.MALE, 1990, 01, 15, 22, "367 445 894", 26000, 3);
		AmbulanceDriver ad3 = new AmbulanceDriver("Sune", "Carlsson", "sc@mail.com", "Stockholm", "0734549782", "SEB",
				"Ambulance Driver", GenderType.MALE, 1985, 11, 29, 23, "789 056 523", 28000, 5);
		AmbulanceDriver ad4 = new AmbulanceDriver("Nina", "Berg", "nb@mail.com", "Huddinge", "0708995485", "Sparbanken",
				"Ambulance Driver", GenderType.FEMALE, 1991, 04, 19, 24, "987 457 452", 22000, 4);
		AmbulanceDriver ad5 = new AmbulanceDriver("Carl", "Frank", "cf@mail.com", "Skärholmen", "07075497852", "SEB",
				"Ambulance Driver", GenderType.FEMALE, 1977, 05, 30, 25, "658 987 452", 30000, 2);
		...
		Housekeeper h2 = new Housekeeper("Anna", "Uber", "au@mail.com", "Tyresö", "0706977452", "SEB", "Housekeeper",
		...
		Housekeeper h4 = new Housekeeper("Gerard", "Bergkvist", "gb@mail.com", "Upplands Väsby", "0756659723", "Nordea",
				"Housekeeper", GenderType.MALE, 1991, 04, 19, 29, "987 357 452", 20000, 12);
		Housekeeper h5 = new Housekeeper("Ture", "Persson", "tp@mail.com", "Skärholmen", "0705497852", "SEB",
		...
		do {
			...
			case "Employee Management":// Employee Management*
				Object[] possibleValues1 = { "Register", "Delete", "Update", "Search", "Display",
				...
				case "Register":// Register
					...
					Object selectedValue3 = JOptionPane.showInputDialog(null,
							"In which category do you want to add the new employee?", "Input",
							JOptionPane.INFORMATION_MESSAGE, null, possibleValues3, possibleValues3[0]);
				...
				case "Search":
					...
					Object selectedValue5 = JOptionPane.showInputDialog(null,
							"How do you want to search for the employee?  ", "Input", JOptionPane.INFORMATION_MESSAGE,
							null, possibleValues5, possibleValues5[0]);
...
//					System.out.println(d+s);
				...
				case "Employee Statistics":// Employee Statistics
					...
					Object selectedValue2 = JOptionPane.showInputDialog(null,
							"Please Choose one from the drop down list: ", "Input", JOptionPane.INFORMATION_MESSAGE,
