...
public class Researcher extends Employee {
	...
	private final int bonusBase = 3000;
	...
	public double calculateBonus() {
		int bonus = bonusBase * NumberOfProjects;
		return bonus;
	}
	...
	public static void createEmployee() {
		...
		int result = JOptionPane.showConfirmDialog(null, myPanel,
				"Please enter all the information about the new Researcher:", JOptionPane.OK_CANCEL_OPTION);
		...
		if (result == JOptionPane.OK_OPTION) {
			...
			Researcher newResearcher = new Researcher(Field2.getText(), Field3.getText(), Field10.getText(),
					Field8.getText(), Field9.getText(), Field13.getText(), "Researcher", genderTemp,
