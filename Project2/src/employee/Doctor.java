...
public class Doctor extends Employee {
	...
	public static void createEmployee(){
	      ...
	      String[] items1 = {"Audiologist", "Allergist", "Anesthesiologist", "Cardiologist", "Dentist", "Dermatologist", "Endocrinologist", "Epidemiologist","Gynecologist", "Immunologist", "Geneticist",
	    		  "Microbiologist", "Neonatologist", "Neurologist", "Neurosurgeon", "Obstetrician", "Oncologist", "Orthopedist", "Pediatrician", "Physiologist", "Podiatrist","Psychiatrist","Radiologist", "Rheumatologist", "Surgeon", "Urologist"};
	      ...
	      int result = JOptionPane.showConfirmDialog(null, myPanel, "Please enter all the information about the new Doctor:", JOptionPane.OK_CANCEL_OPTION);
	      ...
	      if (result == JOptionPane.OK_OPTION) {
	    	  ...
	    	  Doctor newDoctor = new Doctor(Field2.getText(), Field3.getText(), Field10.getText(), Field8.getText(), Field9.getText(), 
	    			  Field13.getText(), "Doctor", genderTemp, Integer.parseInt(Field5.getText()), Integer.parseInt(Field6.getText()), 
	    			  Integer.parseInt(Field7.getText()), Integer.parseInt(Field1.getText()), Field14.getText(), Integer.parseInt(Field12.getText()),special,Integer.parseInt(Field15.getText()));
	      }
