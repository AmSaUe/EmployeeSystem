...
public class Nurse extends Employee {
	...
	public static void createEmployee() {
		...
		int result = JOptionPane.showConfirmDialog(null, myPanel,
				"Please enter all the information about the new Nurse:", JOptionPane.OK_CANCEL_OPTION);
		...
		if (result == JOptionPane.OK_OPTION) {
			...
			Nurse newNurse = new Nurse(Field2.getText(), Field3.getText(), Field10.getText(), Field8.getText(),
					Field9.getText(), Field13.getText(), "Nurse", genderTemp, Integer.parseInt(Field5.getText()),
					Integer.parseInt(Field6.getText()), Integer.parseInt(Field7.getText()),
					Integer.parseInt(Field1.getText()), Field14.getText(), Integer.parseInt(Field12.getText()), qual);
