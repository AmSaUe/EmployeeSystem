...
public class Receptionist extends Employee{
		...
		public static void createEmployee(){
		      ...
		      int result = JOptionPane.showConfirmDialog(null, myPanel, "Please enter all the information about the new Receptionist:", JOptionPane.OK_CANCEL_OPTION);
		      ...
		      if (result == JOptionPane.OK_OPTION) {
		    	  ...
		    	  Receptionist newReceptionist = new Receptionist(Field2.getText(), Field3.getText(), Field10.getText(), Field8.getText(), Field9.getText(), 
		    			  Field13.getText(), "Receptionist", genderTemp, Integer.parseInt(Field5.getText()), Integer.parseInt(Field6.getText()), 
